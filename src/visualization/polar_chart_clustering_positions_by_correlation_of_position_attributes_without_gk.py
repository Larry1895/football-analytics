...
positions_sql = text('SELECT position_id, short_name ' +
                     'from position Where position_id != 5'
                     # Only offensive
                     # + ' And (position_id = 11 OR position_id = 12 OR position_id = 1 OR position_id = 4 OR position_id = 2 OR position_id = 3 OR position_id = 7)'
                     # Only Defensive
                     # + ' And (position_id != 11 And position_id != 12 And position_id != 1 And position_id != 4 And position_id != 2 And position_id != 3 And position_id != 7)'
                     )
